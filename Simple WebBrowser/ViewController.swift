...
class ViewController: UIViewController, WKNavigationDelegate {
    ...
    @objc func openTapped() {
        ...
        ac.addAction(UIAlertAction(title: "Agora.md", style: .default, handler: openPage))
        ac.addAction(UIAlertAction(title: "BBC.com", style: .default, handler: openPage))
        ac.addAction(UIAlertAction(title: "TheGuardian.com", style: .default, handler: openPage))
